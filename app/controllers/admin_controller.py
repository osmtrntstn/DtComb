...
async def index(request: Request, parent_id: str, name: str):
...
async def index(request: Request, id: Optional[str] = "", parent_id: Optional[str] = ""):
...
async def save_function(data: FunctionSchema):
...
async def delete_method(id: str):
    try:
...
async def get_parameter_values(parameter_id: str):
